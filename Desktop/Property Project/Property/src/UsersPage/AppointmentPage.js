            ...
            <div className="header-banner" style={{ backgroundImage: `url(${images[currentImageIndex]})`, transition: "background-image 0.5s ease" }}>
                ...
                <div className="slider-container">
                    <div className="Appt-card">
                        <form>
                    <h1 style={{textAlign: 'center', marginBottom: '10px'}}>Appointment Schedule</h1>
                            ...
                            <div className="appt">
                                <div>
                                    <label>Date</label>
                                    <input type="date" disabled value='Name'/>
                                </div>
                            ...
                            <div>
                                {/* <label>Message</label> */}
                                <textarea disabled rows="8" placeholder="Message"></textarea>
                            </div>

                            <button className="Appt-btn">Reshedule</button>
                            <button className="Appt-btn">Cancel Appointment</button>
                        </form>
                    </div>
                </div>
            </div>
